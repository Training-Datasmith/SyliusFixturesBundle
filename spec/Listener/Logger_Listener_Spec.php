...
final class LoggerListenerSpec extends ObjectBehavior
{
    ...
    public function it_implements_listener_interface(): void
    {
        $this->shouldImplement(ListenerInterface::class);
    }

    public function it_listens_for_before_suite_events(): void
    {
        $this->shouldImplement(BeforeSuiteListenerInterface::class);
    }

    public function it_listens_for_before_fixture_events(): void
    {
        $this->shouldImplement(BeforeFixtureListenerInterface::class);
    }

    public function it_logs_suite_name_on_before_suite_event(LoggerInterface $logger, SuiteInterface $suite): void
    {
    ...
    public function it_logs_fixture_name_on_before_fixture_event(LoggerInterface $logger, SuiteInterface $suite, FixtureInterface $fixture): void
    {
